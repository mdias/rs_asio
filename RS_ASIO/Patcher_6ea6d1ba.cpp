...
// the game has modified the first instruction of NtProtectVirtualMemory from "mov" to a
...
// 1. the untouched first 5 bytes
// 2. a jump to the normal code, resuming execution of NtProtectVirtualMemory
