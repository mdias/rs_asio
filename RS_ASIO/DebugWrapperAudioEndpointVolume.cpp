...
{
	std::cout << m_DeviceId << " " __FUNCTION__ "fLevelDB: " << fLevelDB << std::endl;
...
{
	std::cout << m_DeviceId << " " __FUNCTION__ " fLevel: " << fLevel << std::endl;
...
{
	std::cout << m_DeviceId << " " __FUNCTION__ " nChannel: " << nChannel << " fLevelDB:" << fLevelDB << std::endl;
...
{
	std::cout << m_DeviceId << " " __FUNCTION__ " nChannel: " << nChannel << " fLevel:" << fLevel << std::endl;
...
{
	std::cout << m_DeviceId << " " __FUNCTION__ " bMute: " << bMute << std::endl;
