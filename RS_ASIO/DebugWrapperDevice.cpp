...
{
	std::cout << m_Id << " " __FUNCTION__" - riid: " << riid << "\n";
...
{
	std::cout << m_Id << " " __FUNCTION__ " - Activate iid: " << iid << " dwClsCtx: " << std::hex << dwClsCtx << "\n";
...
{
	std::cout << m_Id << " " __FUNCTION__ " - stgmAccess: " << std::hex << stgmAccess << "\n";
